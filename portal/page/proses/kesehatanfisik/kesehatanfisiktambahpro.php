<div class="panel panel-headline">
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-12">
                <div class="pull-left">
                    <h3 class="panel-title">Data Siswa PJB - Tambah data fisik & kesehatan</h3>
            ...
            <div class="col-md-12">
                <?php 
                    if (isset($_POST['submit'])){
                        ...
                        $count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tbl_kesehatanfisik WHERE nis=$nis"));
                        ...
                        if ($count > 0){
                            ...
                            $insert = mysqli_query($conn, "INSERT INTO tbl_kesehatanfisik SET
                                id_kesehatanfisik       = '$id',
                                nis                     = $nis,
                                tb                      = $tb,
                                warna                   = $warna,
                                lari                    = $lari,
